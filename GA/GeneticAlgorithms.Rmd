...
Perform an implementation of the genetic of the **Schwefel function of 30 variables** algorithm with the standard options, and try to improve the result setting new values of parameters or operators.
...
- solving the problem with with hybrid genetic algorithm with **fmincon** and **interior-point** as local search solvers.
